...
class __TwigTemplate_68d277b8953bd045424da5b647cd33ca2f7093e1a2f86225ae2602665402a18f extends Twig_Template
{
    private $source;
    ...
    public function block_form_row($context, array $blocks = array())
    {
        ...
        // line 5
        if ( !twig_test_empty((isset($context["help"]) || array_key_exists("help", $context) ? $context["help"] : (function () { throw new Twig_Error_Runtime('Variable "help" does not exist.', 5, $this->source); })()))) {
            // line 6
            $context["widget_attr"] = array("attr" => array("aria-describedby" => ((isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new Twig_Error_Runtime('Variable "id" does not exist.', 6, $this->source); })()) . "_help")));
        }
        // line 8
        echo "<tr>
        <td>";
        ...
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 14, $this->source); })()), 'widget', (isset($context["widget_attr"]) || array_key_exists("widget_attr", $context) ? $context["widget_attr"] : (function () { throw new Twig_Error_Runtime('Variable "widget_attr" does not exist.', 14, $this->source); })()));
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 15, $this->source); })()), 'help');
        // line 16
        echo "</td>
    </tr>";
    ...
    public function block_hidden_row($context, array $blocks = array())
    {
        ...
        <td colspan=\"2\">";
        // line 32
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 32, $this->source); })()), 'widget');
        // line 33
        echo "</td>
    </tr>";
    ...
    public function block_form_widget_compound($context, array $blocks = array())
    {
        ...
        echo ">";
        // line 39
        if ((Symfony\Bridge\Twig\Extension\twig_is_root_form((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 39, $this->source); })())) && (twig_length_filter($this->env, (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new Twig_Error_Runtime('Variable "errors" does not exist.', 39, $this->source); })())) > 0))) {
            // line 40
            echo "<tr>
            <td colspan=\"2\">";
            // line 42
    ...
    {
        return array (  181 => 48,  179 => 47,  177 => 46,  173 => 43,  171 => 42,  168 => 40,  166 => 39,  162 => 38,  153 => 37,  142 => 33,  140 => 32,  137 => 30,  128 => 29,  117 => 25,  115 => 24,  111 => 21,  102 => 20,  91 => 16,  89 => 15,  87 => 14,  85 => 13,  82 => 11,  80 => 10,  77 => 8,  74 => 6,  72 => 5,  70 => 4,  61 => 3,  51 => 37,  49 => 29,  47 => 20,  45 => 3,  18 => 1,);
    }
