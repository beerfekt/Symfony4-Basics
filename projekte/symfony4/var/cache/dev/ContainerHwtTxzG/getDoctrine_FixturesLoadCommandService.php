...
$a->addFixtures(array(0 => new \App\DataFixtures\ProductFixture(), 1 => new \App\DataFixtures\UserFixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')))));
